      ...
      <div className="meeting-schedule">
            ...
            <ul>
              ...
              >
                <div className="sidebar-icon">
                  <img
                    src={activeTab === "upcoming" ? UpcomingWhite : Upcoming}
                    alt="Upcoming"
                  />
                </div>
                ...
                <div className="sidebar-arrow-icon">
                  <img
                    src={
                      activeTab === "upcoming" ? ArrowRightWhite : ArrowRight
                    }
                    alt="ArrowRight"
                  />
                </div>
              ...
              >
                <div className="sidebar-icon">
                  <img
                    src={activeTab === "past" ? PastWhite : Past}
                    alt="Past"
                  />
                </div>
                ...
                <div className="sidebar-arrow-icon">
                  <img
                    src={activeTab === "past" ? ArrowRightWhite : ArrowRight}
                    alt="ArrowRight"
                  />
                </div>
              </li>
        ...
        <div className="meeting-schedule__cardwrapper">
          <div className="meeting-schedule__card">
            <div className="meeting-schedule__header"></div>
            {/* <div className="meeting-schedule__content"> */}
            <p className="breadCrumb-title">{activeTab}</p>
            <div
              className={
                loader === true
                  ? "meeting-schedule__content content_load"
                                ...
                                <div className="participant">
                                  {
                                    <>
                                      {event.participants
                                        ...
                                        .map((item) => {
                                          return (
                                            <div className="badges rounded-pill">
                ...
                <div className="modal-content">
                  ...
                  <div className="modal-body">
                    <h5 className="modal-title">
                      Give access to read and send Email
                    </h5>
                    <button
                      className={`googleBtn ${
                        !disableGBtn ? "googleDisable" : "googleEnable"
                      }`}
                      onClick={() => googleLogin()}
                      disabled={!disableGBtn}
                    >
                      <GoogleIconSvg />
                    ...
                    <p className="text-start">
                      <div className="form-check">
                        <input
                          ...
                          id="flexCheckDefault"
                          checked={disableGBtn}
                          onChange={(e) => handleGoogleButton(e)}
                        />
                        <label
                          className="form-check-label"
                          for="flexCheckDefault"
                        >
                          By granting access, you authorize the ability to read
                          and send emails, facilitating a more efficient meeting
                          scheduling process.
                        </label>
                      </div>
                    </p>
